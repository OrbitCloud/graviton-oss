...
V1_PREFIX_SNAPSHOT: dict[str, dict[str, Any]] = {
    ...
    "pulumi_azure_native.cdn.profile": {"prefix": "afd"},
    "pulumi_azure_native.cdn.afd_endpoint": {"prefix": "fde", "lowercase": True},
    "pulumi_azure_native.cdn.afd_origin_group": {"prefix": "afdog"},
    "pulumi_azure_native.cdn.afd_origin": {"prefix": "afdo"},
    "pulumi_azure_native.cdn.route": {"prefix": "afdrt"},
    "pulumi_azure_native.cdn.afd_custom_domain": {"prefix": "afdcd"},
    "pulumi_azure_native.cdn.policy": {"prefix": "fdfp", "alphanumeric": True},
...
V1_NAMING_EXPECTED: dict[str, str] = {
    ...
    "pulumi_azure_native.cdn.profile": "afd-workload-test-neu-01",
    "pulumi_azure_native.cdn.afd_endpoint": "fde-workload-test-neu-01",
    "pulumi_azure_native.cdn.afd_origin_group": "afdog-workload-test-neu-01",
    "pulumi_azure_native.cdn.afd_origin": "afdo-workload-test-neu-01",
    "pulumi_azure_native.cdn.route": "afdrt-workload-test-neu-01",
    "pulumi_azure_native.cdn.afd_custom_domain": "afdcd-workload-test-neu-01",
    "pulumi_azure_native.cdn.policy": "FdfpWorkloadTestNeu01",
...
def test_cross_system_v1_only_resources() -> None:
    ...
    expected_v1_only = {
        ...
        "pulumi_azure_native.cdn.afd_endpoint",
        "pulumi_azure_native.cdn.afd_origin_group",
        "pulumi_azure_native.cdn.afd_origin",
        "pulumi_azure_native.cdn.route",
        "pulumi_azure_native.cdn.afd_custom_domain",
        "pulumi_azure_native.cdn.policy",
    }
