...
<!--
  Derived from: .claude/agents/dev.md
  This file is a Copilot-compatible adaptation of the Claude Code developer agent definition.
  The .claude/agents/dev.md file is the authoritative source of truth. When that file changes
